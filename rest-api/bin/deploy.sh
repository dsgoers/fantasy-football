...
aws lambda create-function --function-name hello-world --package-type Image --code ImageUri=452385826394.dkr.ecr.us-east-1.amazonaws.com/hello-world:latest --role arn:aws:iam::452385826394:role/lambda-ex